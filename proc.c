...
// Global Variables:
// add variable for policy
int curr_policy = 1;
long long quan_time = 1;
...
//                    change scheduling policy with new system call
