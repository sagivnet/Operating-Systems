...
main(int argc, char *argv[])
{
  ...
  20:	ba 88 07 00 00       	mov    $0x788,%edx
  25:	b9 8a 07 00 00       	mov    $0x78a,%ecx
  ...
  4c:	c7 44 24 0c 8f 07 00 	movl   $0x78f,0xc(%esp)
  53:	00 
  54:	89 44 24 08          	mov    %eax,0x8(%esp)
  58:	c7 44 24 04 8a 07 00 	movl   $0x78a,0x4(%esp)
  5f:	00 
  60:	c7 04 24 01 00 00 00 	movl   $0x1,(%esp)
  67:	e8 a4 03 00 00       	call   410 <printf>
  exit(0);
...
printf(int fd, const char *fmt, ...)
{
 ...
 5e8:	e9 7e fe ff ff       	jmp    46b <printf+0x5b>
          s = "(null)";
 5ed:	bb 91 07 00 00       	mov    $0x791,%ebx
        while(*s != 0){
 ...
 601:	a1 28 0a 00 00       	mov    0xa28,%eax
{
 ...
 647:	5b                   	pop    %ebx
  freep = p;
 648:	a3 28 0a 00 00       	mov    %eax,0xa28
}
 64d:	5e                   	pop    %esi
 64e:	5f                   	pop    %edi
 64f:	5d                   	pop    %ebp
 ...
 65e:	72 ce                	jb     62e <free+0x2e>
{
 ...
 681:	8b 4b fc             	mov    -0x4(%ebx),%ecx
  freep = p;
 684:	a3 28 0a 00 00       	mov    %eax,0xa28
    p->s.size += bp->s.size;
...
malloc(uint nbytes)
{
 ...
 6a9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6ac:	8b 15 28 0a 00 00    	mov    0xa28,%edx
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 ...
 6ef:	73 3f                	jae    730 <malloc+0x90>
    ...
    if(p == freep)
 6f1:	39 05 28 0a 00 00    	cmp    %eax,0xa28
 ...
 711:	e8 ea fe ff ff       	call   600 <free>
  return freep;
 716:	8b 15 28 0a 00 00    	mov    0xa28,%edx
 ...
 73c:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 73f:	89 15 28 0a 00 00    	mov    %edx,0xa28
}
 ...
 74f:	c3                   	ret    
    base.s.ptr = freep = prevp = &base;
 750:	b8 2c 0a 00 00       	mov    $0xa2c,%eax
 755:	ba 2c 0a 00 00       	mov    $0xa2c,%edx
    base.s.size = 0;
 75a:	31 c9                	xor    %ecx,%ecx
    base.s.ptr = freep = prevp = &base;
 75c:	a3 28 0a 00 00       	mov    %eax,0xa28
    base.s.size = 0;
 761:	b8 2c 0a 00 00       	mov    $0xa2c,%eax
    base.s.ptr = freep = prevp = &base;
 766:	89 15 2c 0a 00 00    	mov    %edx,0xa2c
    base.s.size = 0;
 76c:	89 0d 30 0a 00 00    	mov    %ecx,0xa30
