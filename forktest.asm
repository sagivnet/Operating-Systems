...
00000050 <forktest>:
{
  ...
  54:	53                   	push   %ebx
  write(fd, s, strlen(s));
  55:	bb 88 04 00 00       	mov    $0x488,%ebx
{
  5a:	83 ec 20             	sub    $0x20,%esp
  write(fd, s, strlen(s));
  5d:	c7 04 24 88 04 00 00 	movl   $0x488,(%esp)
  ...
  a9:	8d 75 f4             	lea    -0xc(%ebp),%esi
  for(; n > 0; n--){
  ac:	74 11                	je     bf <forktest+0x6f>
  ae:	66 90                	xchg   %ax,%ax
    if(wait(&tmp) < 0){
  ...
  write(fd, s, strlen(s));
  ce:	c7 04 24 ba 04 00 00 	movl   $0x4ba,(%esp)
  d5:	e8 26 01 00 00       	call   200 <strlen>
  da:	ba ba 04 00 00       	mov    $0x4ba,%edx
 ...
 12c:	e8 97 02 00 00       	call   3c8 <exit>
  write(fd, s, strlen(s));
 131:	c7 04 24 93 04 00 00 	movl   $0x493,(%esp)
 138:	e8 c3 00 00 00       	call   200 <strlen>
 13d:	b9 93 04 00 00       	mov    $0x493,%ecx
 ...
 15d:	e8 66 02 00 00       	call   3c8 <exit>
  write(fd, s, strlen(s));
 162:	c7 04 24 a7 04 00 00 	movl   $0x4a7,(%esp)
 169:	e8 92 00 00 00       	call   200 <strlen>
 16e:	c7 44 24 04 a7 04 00 	movl   $0x4a7,0x4(%esp)
 175:	00 
